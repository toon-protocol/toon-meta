...
- **Publish via `pnpm publish` / changesets, never `npm publish`.** *Why:* `npm publish` shipped unresolved `workspace:*`, making `sdk@0.5.0`/`relay@0.4.0` uninstallable. (See `SKILLS_AUDIT.md` lineage / the split plan.)
