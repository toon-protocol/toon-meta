...
- [x] Task 1: Initialize monorepo structure (AC: 1)
  ...
  - [x] Create `packages/core/` directory with `package.json` for `@agent-society/core`
  - [x] Create `packages/relay/` directory with `package.json` for `@agent-society/relay`
  - [x] Create `packages/examples/` directory with `package.json` for `@agent-society/examples`
...
- `packages/core/package.json` - @agent-society/core package
...
- `packages/relay/package.json` - @agent-society/relay package
...
- `packages/examples/package.json` - @agent-society/examples package
