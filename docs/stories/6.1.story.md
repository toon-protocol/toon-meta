...
- Docker image published: `di3twater/agent-society-bls`
...
Current `@agent-society/core` dependencies:
- `nostr-tools: ^2.20.0`
- `ws: ^8.18.0`
...
- Custom error classes extending `AgentSocietyError` for throwable errors
