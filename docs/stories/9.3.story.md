...
**I want** to bump the version of `@agent-society/core`, `@agent-society/bls`, and `@agent-society/relay` from `0.1.0` to `1.0.0`,
...
5. The `@agent-society/examples` package version is NOT changed (stays `0.1.0`, it is `"private": true`)
...
- [x] Task 1: Bump `@agent-society/core` version to `1.0.0` (AC: 1, 6)
  - [x] Open `packages/core/package.json`
  - [x] Change `"version": "0.1.0"` to `"version": "1.0.0"` (line 3)
  - [x] Verify no other fields were modified

- [x] Task 2: Bump `@agent-society/bls` version to `1.0.0` (AC: 2, 6)
  - [x] Open `packages/bls/package.json`
  - [x] Change `"version": "0.1.0"` to `"version": "1.0.0"` (line 3)
  - [x] Verify no other fields were modified

- [x] Task 3: Bump `@agent-society/relay` version to `1.0.0` (AC: 3, 6)
...
- [x] Task 5: Verify `workspace:*` references are NOT changed (AC: 6)
  - [x] Confirm `packages/relay/package.json` still has `"@agent-society/bls": "workspace:*"` and `"@agent-society/core": "workspace:*"` in dependencies
  - [x] Confirm `packages/core/package.json` still has `"@agent-society/relay": "workspace:*"` in devDependencies
...
- `packages/relay/package.json` dependencies: `"@agent-society/bls": "workspace:*"`, `"@agent-society/core": "workspace:*"`
- `packages/core/package.json` devDependencies: `"@agent-society/relay": "workspace:*"`
- `packages/examples/package.json` dependencies: `"@agent-society/core": "workspace:*"`, `"@agent-society/relay": "workspace:*"`
...
- `@agent-society/examples` stays `"private": true` at `0.1.0`
...
```
packages/
├── core/     # @agent-society/core — bump to 1.0.0
├── bls/      # @agent-society/bls — bump to 1.0.0
├── relay/    # @agent-society/relay — bump to 1.0.0
└── examples/ # @agent-society/examples — stays at 0.1.0 (private)
```
