...
For TOON, the binding "requirements" are not the abstract RFC but the connector's **release/version contract**, because TOON's SDK and town/store/mill depend on a specific connector API:
