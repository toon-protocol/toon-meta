...
- use its **ILP address** (`g.proxy.relay` for the default relay) as the packet destination, and
...
- ILP addresses (`g.proxy`, `g.proxy.relay`) as routing destinations
