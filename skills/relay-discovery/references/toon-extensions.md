...
For the complete TOON write model, read model, and fee calculation details, refer to `skills/nostr-protocol-core/references/toon-protocol-context.md`. This file covers relay-discovery-specific extensions; the protocol core covers foundational mechanics shared by all event kinds.
