...
- `MILL_E2E_EVM_SENDER_PRIVATE_KEY` / `MILL_E2E_EVM_SENDER_ADDRESS` — Anvil account **#1** (disjoint from SDK-claimed #3–#10).
- `MILL_E2E_EVM_SENDER_PRIVATE_KEY_ALT` / `MILL_E2E_EVM_SENDER_ADDRESS_ALT` — Anvil account **#2**.
...
- [x] Allocated Anvil accounts #1 and #2 (disjoint from SDK E2E #3–#10)
