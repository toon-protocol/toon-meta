...
# Test Design Progress — Epic 5: The Rig
...
**Rationale:** User explicitly requested "epic 5". Epic-level test design produces a single test-design-epic-5.md document.

**Prerequisites Verified:**

- Requirements baseline: `_bmad-output/planning-artifacts/epics.md` (Epic 5: Stories 5.1-5.12, 6 FRs: FR-NIP34-1 through FR-NIP34-6)
...
- `_bmad-output/planning-artifacts/epics.md` — Epic 5: 12 stories, 6 FRs
...
- 5 high-priority (score >=6): E5-R001 through E5-R005
- 5 medium (score 3-4): E5-R006 through E5-R010
- 3 low (score 1-2): E5-R011, E5-R012, E5-R013

**Top Risks:** 4 SEC-category risks (git injection, auth bypass, path traversal, XSS) — all score 6
**Inherited from system-level:** R-004 → E5-R001, R-009 → E5-R006, R-012 → E5-R011

## Step 4: Coverage Plan & Execution Strategy

**Coverage Matrix (Epic 5):**
...
- `_bmad-output/test-artifacts/test-design-epic-5.md` — Epic 5 test design (risk assessment, coverage matrix, execution strategy, resource estimates, quality gates)
