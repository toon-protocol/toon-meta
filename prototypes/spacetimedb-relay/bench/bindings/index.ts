...
import PostFrameReducer from "./post_frame_reducer";

// Import all procedure arg schemas

// Import all table schema definitions
import EventsRow from "./events_table";
import FramesRow from "./frames_table";
...
const tablesSchema = __schema({
  events: __table({
    name: 'events',
    indexes: [
      { accessor: 'author', name: 'events_author_idx_btree', algorithm: 'btree', columns: [
        'author',
      ] },
      { accessor: 'id', name: 'events_id_idx_btree', algorithm: 'btree', columns: [
        'id',
      ] },
      { accessor: 'kind', name: 'events_kind_idx_btree', algorithm: 'btree', columns: [
        'kind',
      ] },
    ],
    constraints: [
...
const reducersSchema = __reducers(
  ...
  __reducerSchema("post_frame", PostFrameReducer),
);
